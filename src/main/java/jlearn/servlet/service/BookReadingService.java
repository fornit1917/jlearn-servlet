    ...
    public PageResult<BookReadingHistoryItem> getListForHistory(int userId, int year, PageRequest pageRequest) throws SQLException
    {
        try (Connection conn = ds.getConnection()) {
            ...
            st = queryBuilder
                ...
                .orderBy("CASE WHEN br.end_year=0 and br.start_year!=0 THEN date_part('year', CURRENT_DATE)*1000 + 13 ELSE (br.end_year * 1000 + br.end_month) END DESC, br.start_year * 1000 + br.start_month DESC, b.id DESC")
